"""
End-to-end pipeline experiment on the iris dataset:
...
def main():
    parser = argparse.ArgumentParser(description="End-to-end pipeline on iris.")
    ...
    audit_report_to_json(report, "audit_report_iris.json")
